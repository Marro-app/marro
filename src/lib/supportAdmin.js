...
// to their email if no name is on file), never a "you"/"me" special case,
// so it reads the same regardless of which founder is looking at it.
// `namesByEmail` is a lowercase-email → display-name lookup.
