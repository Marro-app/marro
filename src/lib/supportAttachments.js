...
// `attachments` jsonb: [{ path, type, w, h }]; rendering resolves a
// short-lived signed URL per ref.
...
export async function uploadAttachment(blob, { width = null, height = null } = {}) {
  ...
  return { path, type: 'image/png', w: width, h: height };
}
