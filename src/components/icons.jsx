...
const ICONS = {
  ...
  // Support-category icons (chosen from the Marro-style options)
  help:     () => <><circle cx="10" cy="10" r="7"/><path d="M8.6 8.3a1.6 1.6 0 0 1 3 .6c0 1.1-1.5 1.3-1.5 2.3"/><circle cx="10.1" cy="13.3" r="0.6" fill="currentColor" stroke="none"/></>,
  bug:      () => <><ellipse cx="10" cy="10.6" rx="3" ry="4"/><path d="M10 6.9v7.4"/><circle cx="10" cy="5.4" r="1.4"/><path d="M9.1 4.4 8.1 3.2M10.9 4.4 11.9 3.2"/><path d="M7 8.4 4.7 7M6.8 10.8 4.4 10.8M7.1 13.2 5 14.6M13 8.4 15.3 7M13.2 10.8 15.6 10.8M12.9 13.2 15 14.6"/></>,
  idea:     () => <><path d="M7.7 11.5a3.4 3.4 0 1 1 4.6 0c-.5.5-.8.9-.8 1.6H8.5c0-.7-.3-1.1-.8-1.6Z"/><path d="M8.7 14.7h2.6M9.1 16h1.8"/><path d="M10 2.6V4M4.7 5.1 5.7 6.1M15.3 5.1 14.3 6.1"/></>,
  reopen:   () => <><path d="M15.9 10.6a6 6 0 1 1-1.7-4.8"/><path d="M16.2 3.6v2.6h-2.6"/></>,
  // CSAT thumbs (support "Chat ended" rating, Slice 11) — Marro line style,
  // no emoji (support-chat decision 10).
  thumbup:  () => <><path d="M6.2 9.2v7H4.2a.8.8 0 0 1-.8-.8v-5.4a.8.8 0 0 1 .8-.8Z"/><path d="M6.2 9.6l3-5.4a1.5 1.5 0 0 1 2.8.7v3h3.3a1.5 1.5 0 0 1 1.5 1.8l-1 5a1.5 1.5 0 0 1-1.5 1.2H6.2"/></>,
  thumbdown:() => <><path d="M13.8 10.8v-7h2a.8.8 0 0 1 .8.8V10a.8.8 0 0 1-.8.8Z"/><path d="M13.8 10.4l-3 5.4a1.5 1.5 0 0 1-2.8-.7v-3H4.7a1.5 1.5 0 0 1-1.5-1.8l1-5a1.5 1.5 0 0 1 1.5-1.2h8.1"/></>,
  plus:     () => <path d="M10 4.5v11M4.5 10h11"/>,
  check:    () => <path d="M5 10.5l3.2 3.2L15 6.8"/>,
  chevron:  () => <path d="M5.5 8l4.5 4.5L14.5 8"/>,
  wallet:   () => <><rect x="3.4" y="5.6" width="13.2" height="9.4" rx="2"/><path d="M3.4 8.9h13.2"/><circle cx="12.8" cy="12" r="0.85" fill="currentColor" stroke="none"/></>,
  arrowUp:  () => <path d="M10 15.5V5.2M6 8.8L10 4.8l4 4"/>,
  arrowDown:() => <path d="M10 4.5v10.3M6 11.2l4 4 4-4"/>,
